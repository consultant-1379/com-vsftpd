...
// this variable is locally declared here.
#define	LOG_SECURITY_AUDIT	(13<<3)

// Defines related to logging
#define APPLICATION_NAME "vsftpd"
#define LOGGER_UNIX_SOCKET "/dev/log"
#define LOGGER_MESSAGE_ID "security_audit"
...
const char* vsf_sysutil_getnameinfo(const char* ip);

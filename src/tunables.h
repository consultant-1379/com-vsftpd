...
extern int tunable_ssl_user_auth_cert;        /* Allow extracting username from certificate as login user*/
extern int tunable_ssl_crosscheck_username;   /* Allow crosscheck extracted username with client provided*/
